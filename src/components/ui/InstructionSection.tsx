...
export default function InstructionSection({ data }: InstructionSectionProps) {
          ...
          >
            ...
            <Accordion.Content asChild forceMount style={{ display: "block" }}>
              ...
              >
                ...
                >
                  <div className="relative max-w-xs rounded-2xl bg-green-600 px-4 py-2 text-white">
                    {item.description}
                    <div className="absolute bottom-0 right-0 h-0 w-0 border-l-[10px] border-t-[10px] border-l-transparent border-t-green-600"></div>
                  </div>
                </div>
              </motion.div>
            </Accordion.Content>
